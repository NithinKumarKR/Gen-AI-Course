...
# Load model safely (prevent deserialization issue)
model = load_model("reg_model.h5", compile=False)
...
Insulin = st.selectbox("Insulin Intake", Insulin_label.classes_)
...
#    'glucose_level': glucose_level,
    ...
    'Insulin': Insulin_label.transform([Insulin])[0]
}
...
st.success(f"Predicted Insulin Dosage: {pred[0][0]}")
